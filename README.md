# archiver 📁
`archiver` is a compressing/decompressing tool that I made for educational purposes (specifically, it was a hometask given at a C++ course in the [HSE](https://www.hse.ru/en/) university).
